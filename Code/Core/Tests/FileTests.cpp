...
const char* SAMPLE_FILE = "D:\\Game Development\\Engine\\LiteForge\\Temp\\FileTest_SyncFile.txt";
const char* TEST_DIR_PATH = "D:\\Game Development\\Engine\\LiteForge\\Temp\\";
...
{
    const String TEST_DIR(TEST_DIR_PATH);
